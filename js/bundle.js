...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    ...
    function showThanksModal(messeage) {
      var prevModalDalog = document.querySelector('.modal__dialog');
      ...
      thanksModal.innerHTML = "\n                <div class=\"modal__content\"> \n                    <div class=\"modal__close\" data-close>\xD7</div>\n                    <div class=\"modal__title\">".concat(messeage, "</div>\n                </div>\n            ");
      document.querySelector('.modal').append(thanksModal);
      setTimeout(function () {
        thanksModal.remove();
        prevModalDalog.classList.add('show');
        prevModalDalog.classList.remove('hide');
        (0,_modal__WEBPACK_IMPORTED_MODULE_9__.hideModal)('.modal');
      }, 4000);
    }
  }
  fetch('http://localhost:3000/requests').then(function (data) {
    return data.json();
  }).then(function (res) {
...
function hideModal(modalSelector) {
  var modalContent = document.querySelector(modalSelector);
...
function modal(tirggeredSelector, modalSelector, modalTimerId) {
  ...
  var openModal = document.querySelectorAll(tirggeredSelector),
...
function slides(_ref) {
  ...
  var counter = 1,
    offset = 0;
  console.log(width);
  totalIndex.innerHTML = "".concat((0,_timer__WEBPACK_IMPORTED_MODULE_5__.getZero)(Sliders.length));
  ...
  Sliders.forEach(function (slider) {
    return slider.style.width = width;
  });
  ...
  nextSlider.addEventListener('click', function () {
    ...
    slidersField.style.transform = "translateX(-".concat(offset, "px)");
    if (counter == Sliders.length) {
      counter = 1;
    } else {
      counter++;
    }
    currentIndex.textContent = "".concat((0,_timer__WEBPACK_IMPORTED_MODULE_5__.getZero)(counter));
    forDots(dots, '.5');
  });
...
/* harmony import */ var _zahar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./zahar */ "./js/modules/zahar.js");
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  console.log(_zahar__WEBPACK_IMPORTED_MODULE_4__.Zahar);
  //Tabs
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Zahar": () => (/* binding */ Zahar)
/* harmony export */ });
var Zahar = 'Hello Zahar';
console.log(Zahar);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fetch status: ".concat(res.status));
        case 5:
          _context2.next = 7;
          return res.json();
        case 7:
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_5__["default"])('[data-open]', '.modal', modalTimerId);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2023-4-20');
